...
//    private CVRPIndividual rouletteWheel(CVRPIndividual[][] individuals)
//    {
//    	
//    	double r = inputGenerator.nextDouble();
//    	double totalFitness = 0;
//    	double accumulator = 0;
//    	double[][] probs = new double[WIDTH][HEIGHT];
//    	
//		for(int x = 0; x < WIDTH; x++)
//		{
//			for(int y = 0; y < HEIGHT; y++)
//			{
//				totalFitness += individuals[x][y].getFitness();
//			}
//    	}
//		
//		for(int x = 0; x < WIDTH; x++)
...
//			for(int y = 0; y < HEIGHT; y++)
//			{
//				probs[x][y] =  individuals[x][y].getFitness()/totalFitness;
//			}
//    	}
//		
//    	// Find the point on the wheel
//		for(int x = 0; x < WIDTH; x++)
//		{
//			for(int y = 0; y < HEIGHT; y++)
//			{
//				accumulator += probs[x][y];
//				if (r <= accumulator) return individuals[x][y];
//			}
//    	}
//		return individuals[0][0];
//    }
	...
	public static void main(String[] args)
	{
		...
		GeneticAlgorithm ga = new GeneticAlgorithm(Integer.parseInt(args[0]));
...
//					CVRPIndividual parent1 = ga.rouletteWheel(ga.individuals);
					...
					// Local search
//					CVRPIndividual offspring = parent2;			
